...
import org.serratec.bakcend.servicedto.domain.FuncionarioDTO;
...
import org.serratec.bakcend.servicedto.service.FotoService;
import org.serratec.bakcend.servicedto.service.FuncionarioService;
...
public class FuncionarioController {
	...
	public ResponseEntity<FuncionarioDTO> inserir(@RequestPart MultipartFile file, @RequestPart Funcionario funcionario)
			throws IOException {
	...
	/*
	 * @GetMapping public ResponseEntity<List<Funcionario>> listar() {
	 * List<Funcionario> funcionarios = funcionarioRepository.findAll(); return
